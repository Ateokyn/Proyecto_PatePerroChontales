 ...
 */
public class InternalFrameGiras extends javax.swing.JInternalFrame {

    /**
     * Creates new form IntenalFrameGira
     */
    public InternalFrameGiras() {
        initComponents();
    ...
    public void obtenerDatos() {
        ...
        List<Giras> giras = new DAOGiras().ObtenerDatos();
        //Define un modelo para la tabla.
        DefaultTableModel modelo = new DefaultTableModel();
        //Arreglo con nombre de caolumnas de la tabla.
        String[] columnas1 = {"id_gira", "Nombre Gira", "Precio Gira",
            "Distancia Gira", "Fecha Gira", "id_Encargado"};
        ...
        for (Giras gs : giras) {
            String[] renglon = {Integer.toString(gs.getId_gira()), gs.getNombre_gira(),
                ...
                Integer.toString(gs.getId_emplG())};
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jtxtFechaGira, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
                            .addComponent(jLabel6)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel1)
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Empleados Registrados", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(0, 0, 255))); // NOI18N
    ...
    private void btnAgregarGiraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarGiraActionPerformed
        ...
        if (gir.contentEquals("") || prec.contentEquals("")
            ...
            try {
                ...
                float precio = Float.valueOf(prec);
                float distanci = Float.valueOf(dist);
                int id_emple = Integer.valueOf(id_empl);
                Giras gs = new DAOGiras().Insertar(gir, precio, distanci, fechg, id_emple);
    ...
    private void btnEditarGiraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarGiraActionPerformed
        ...
        if (fila == -1) {
            ...
            try {
                ...
                float precG = Float.parseFloat((String) this.JTableGiras.getValueAt(fila, 2).toString());
                float distG = Float.parseFloat((String) this.JTableGiras.getValueAt(fila, 3).toString());
